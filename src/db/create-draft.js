...
const draftContent = readFileSync('./content/drafts/building-lasting-habits-pearl-visualization-v1.md', 'utf8');
...
console.log(`Linked to plan_id: 1`);
