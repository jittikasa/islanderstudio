    ...
    <div className="min-h-screen bg-[#FAFAF5] text-stone-800 selection:bg-pola-red selection:text-white">
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-[#FAFAF5]/90 backdrop-blur-md shadow-sm py-4' : 'bg-transparent py-6'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-3 cursor-pointer" onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}>
            <img src="/polamoment/Icon-1024.png" alt="PolaMoment" className="w-10 h-10 rounded-2xl" />
          ...
          <div className="hidden md:flex items-center gap-8 text-sm font-medium tracking-wide text-stone-600">
            ...
            <Link to="/privacy" className="hover:text-pola-red transition-colors cursor-pointer uppercase">Privacy</Link>
            <a href="#download" onClick={scrollToSection('download')} className="px-5 py-2 bg-pola-black text-white rounded-full hover:bg-pola-red transition-colors shadow-sm cursor-pointer flex items-center gap-2">
              <Apple size={18} />
              Get App
            </a>
          </div>
      ...
      {menuOpen && (
        <div className="fixed inset-0 z-40 bg-[#FAFAF5] flex flex-col items-center justify-center gap-8 text-xl font-serif animate-fade-in">
          <a href="#story" onClick={scrollToSection('story')} className="hover:text-pola-red transition-colors cursor-pointer uppercase">Story</a>
          <a href="#download" onClick={scrollToSection('download')} className="hover:text-pola-red transition-colors cursor-pointer uppercase">Download</a>
          <Link to="/privacy" onClick={() => setMenuOpen(false)} className="hover:text-pola-red transition-colors cursor-pointer uppercase">Privacy</Link>
          <a href="#download" onClick={scrollToSection('download')} className="px-6 py-3 bg-pola-black text-white rounded-full shadow-lg cursor-pointer flex items-center gap-2">
            <Apple size={20} />
            Get App
          </a>
        </div>
      ...
      <main>
        ...
        <section className="py-24 bg-stone-900 text-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <Link to="/privacy" className="inline-block px-8 py-3 bg-white text-stone-900 rounded-full hover:bg-pola-red hover:text-white transition-all duration-300 font-medium hover:scale-105 transform animate-fade-in-up shadow-lg hover:shadow-xl" style={{ animationDelay: '0.5s' }}>
              Read Privacy Policy
            </Link>
          </div>
        </section>
        ...
        <section id="download" className="py-24 bg-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <a href="#" className="inline-flex items-center gap-3 px-10 py-5 bg-pola-black text-white rounded-full hover:bg-pola-red transition-all duration-300 shadow-lg hover:shadow-2xl transform hover:scale-110 text-lg font-medium animate-fade-in-up" style={{ animationDelay: '0.5s' }}>
      ...
      <footer className="bg-stone-900 text-stone-400 py-16">
        <div className="container mx-auto px-6">
          ...
          <div className="text-center pt-8 border-t border-stone-800 text-xs text-stone-600">
            <p>© 2025 PolaMoment<span className="text-pola-red">.</span> All rights reserved.</p>
